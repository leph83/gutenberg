...
class WP_Theme_JSON_Schema_V0_Test extends WP_UnitTestCase {
	...
	function test_get_stylesheet() {
		...
		$this->assertEquals(
			'body{--wp--preset--color--grey: grey;--wp--preset--font-family--small: 14px;--wp--preset--font-family--big: 41px;}.wp-block-group{--wp--custom--base-font: 16;--wp--custom--line-height--small: 1.2;--wp--custom--line-height--medium: 1.4;--wp--custom--line-height--large: 1.8;}body{color: var(--wp--preset--color--grey);}a:not(.wp-block-button_link){color: var(--wp--style--color--link, #111);}h1{font-size: 1em;}h2{font-size: 2em;}.wp-block-group{padding-top: 12px;padding-bottom: 24px;}.wp-block-group a:not(.wp-block-button_link){color: var(--wp--style--color--link, #333);}h1 a:not(.wp-block-button_link),h2 a:not(.wp-block-button_link),h3 a:not(.wp-block-button_link),h4 a:not(.wp-block-button_link),h5 a:not(.wp-block-button_link),h6 a:not(.wp-block-button_link){color: var(--wp--style--color--link, #222);}.wp-block-post-title{font-size: 5em;}.wp-block-post-title a:not(.wp-block-button_link){color: var(--wp--style--color--link, #555);}.wp-block-query-title{font-size: 5em;}.wp-block-query-title a:not(.wp-block-button_link){color: var(--wp--style--color--link, #555);}.has-grey-color{color: grey !important;}.has-grey-background-color{background-color: grey !important;}.has-grey-border-color{border-color: grey !important;}',
			$theme_json->get_stylesheet()
		);
		$this->assertEquals(
			'body{color: var(--wp--preset--color--grey);}a:not(.wp-block-button_link){color: var(--wp--style--color--link, #111);}h1{font-size: 1em;}h2{font-size: 2em;}.wp-block-group{padding-top: 12px;padding-bottom: 24px;}.wp-block-group a:not(.wp-block-button_link){color: var(--wp--style--color--link, #333);}h1 a:not(.wp-block-button_link),h2 a:not(.wp-block-button_link),h3 a:not(.wp-block-button_link),h4 a:not(.wp-block-button_link),h5 a:not(.wp-block-button_link),h6 a:not(.wp-block-button_link){color: var(--wp--style--color--link, #222);}.wp-block-post-title{font-size: 5em;}.wp-block-post-title a:not(.wp-block-button_link){color: var(--wp--style--color--link, #555);}.wp-block-query-title{font-size: 5em;}.wp-block-query-title a:not(.wp-block-button_link){color: var(--wp--style--color--link, #555);}.has-grey-color{color: grey !important;}.has-grey-background-color{background-color: grey !important;}.has-grey-border-color{border-color: grey !important;}',
